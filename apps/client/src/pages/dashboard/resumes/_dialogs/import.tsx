        ...
        <Form {...form}>
          <form className="space-y-4">
            <DialogHeader>
              ...
              <DialogDescription>
                {t`Upload a file from one of the accepted sources to parse existing data and import it into Resume Lister for easier editing.`}
              </DialogDescription>
            </DialogHeader>
                  ...
                  <FormControl>
                    <Select value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="reactive-resume-json">Resume Lister (.json)</SelectItem>
                        {/* eslint-disable-next-line lingui/no-unlocalized-strings */}
                        <SelectItem value="reactive-resume-v3-json">
                          Resume Lister v3 (.json)
                        </SelectItem>
                        {/* eslint-disable-next-line lingui/no-unlocalized-strings */}
